...
type FastFoodScreenProp = NavigationProp<RootStackParamList, 'FastFood'>;
...
export default function FastFood() {
  const navigation = useNavigation<FastFoodScreenProp>();
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/recipes?category=Fast Food`)
      .then(res => res.json())
      .then(data => {
