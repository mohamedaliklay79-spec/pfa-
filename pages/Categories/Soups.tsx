...
type SoupsScreenProp = NavigationProp<RootStackParamList, 'Soups'>;
...
export default function Soups() {
  const navigation = useNavigation<SoupsScreenProp>();
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/recipes?category=Soups`)
      .then(res => res.json())
      .then(data => {
  ...
  return (
    <ImageBackground source={require('../../photo/loginbackground.jpg')} style={styles.background} resizeMode="cover">
      ...
      <View style={styles.overlay}>
        ...
        <Text style={styles.title}>🍜 Soups</Text>
