...
type DrinksScreenProp = NavigationProp<RootStackParamList, 'Drinks'>;
...
export default function Drinks() {
  const navigation = useNavigation<DrinksScreenProp>();
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/recipes?category=Drinks`)
      .then(res => res.json())
      .then(data => {
