...
type VegetarianScreenProp = NavigationProp<RootStackParamList, 'Vegetarian'>;
...
export default function Vegetarian() {
  const navigation = useNavigation<VegetarianScreenProp>();
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/recipes?category=Vegetarian`)
      .then(res => res.json())
      .then(data => {
