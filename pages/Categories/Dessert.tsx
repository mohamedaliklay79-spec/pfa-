...
type DessertScreenProp = NavigationProp<RootStackParamList, 'Dessert'>;
...
export default function Dessert() {
  const navigation = useNavigation<DessertScreenProp>();
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/recipes?category=Dessert`)
      .then(res => res.json())
      .then(data => {
