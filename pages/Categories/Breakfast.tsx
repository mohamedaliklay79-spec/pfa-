...
type BreakfastScreenProp = NavigationProp<RootStackParamList, 'Breakfast'>;
...
export default function Breakfast() {
  const navigation = useNavigation<BreakfastScreenProp>();
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/recipes?category=Breakfast`)
      .then(res => res.json())
      .then(data => {
